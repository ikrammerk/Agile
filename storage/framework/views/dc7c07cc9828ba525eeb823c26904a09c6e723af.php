...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Price(MAD) <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <select name="Memory[]" class="form-control selectpicker"  multiple data-live-search="true">
              <option value="">--Select any size--</option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WWW\Ecommerce-laravel7\resources\views/backend/product/create.blade.php ENDPATH**/ ?>