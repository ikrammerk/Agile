                    ...
                    <td>
                     <ul style="list-style:none">
                          ...
                          <?php if($review->rate >=$i): ?>
                            <li style="float:left;color:#4891ad;"><i class="fa fa-star"></i></li>
                          <?php else: ?> 
                            <li style="float:left;color:#4891ad;"><i class="far fa-star"></i></li>
                          <?php endif; ?>
                        <?php endfor; ?>
                     </ul>
                    </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eCommerce-website-main\resources\views/backend/review/index.blade.php ENDPATH**/ ?>