				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> <a href="http://www.ens-marrakech.ac.ma" target="_blank">Shop M2K</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  </script><?php /**PATH C:\xampp\htdocs\eCommerce-website-main\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>