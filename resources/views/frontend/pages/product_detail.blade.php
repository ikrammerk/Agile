...
@endsection
@section('title','SHOP-M2K || PRODUCT DETAIL')
											...
											<div class="short">
                                                ...
                                                @endphp
													<br><div class="product-price">
														...
														@elseif($product_detail->discount!=null)
														<span>${{number_format(($product_detail->price-($product_detail->price*$product_detail->discount)/100),2)}}</span>
														<del style="padding-left:4%;">${{number_format($product_detail->price,2)}}</del>
														@endif
													</div>
											...
											@if($product_detail->size)
												<br><div class="size mt-4">
													...
													<select>
														...
														<option><a href="#" class="one">{{$size}}</a></option>
														@endforeach
													</select>
												</div>
											@endif
